    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <div class="header-content">
        ...
        <div class="shop-message" >
          <span style="position: absolute;left: 30px;" class="shop-message-detail">{{info.score}}</span>
          <span style="position: absolute;left: 60px;" class="shop-message-detail">月售{{info.sellCount}}单</span>
          <span style="position: absolute;left: 120px;" class="shop-message-detail">
            {{info.description}}
            <span style="position: absolute;left: 150px;" >约{{info.deliveryTime}}分钟</span>
          </span>
          <span style="position: absolute;left: 180px;" class="shop-message-detail">距离{{info.distance}}</span>
        </div>
      </div>
    </div>
